              ...
              <div class="swiper-wrapper">
                <template v-for="(category, index) in categoryData">
                  <div class="swiper-slide" v-if="currentIndex == category.categoryId" :key="index">
                    ...
                    <div class="category-list" v-for="(products, index) in category.subCategories" :key="index">
                      <p class="catogory-title">{{products.categoryName}}</p>
                      <div class="product-item" v-for="(product, index) in products.subCategories" :key="index" @click="selectProduct(product)">
